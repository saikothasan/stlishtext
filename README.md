...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ras
```

A live public deployment of this template is available at [https://ras.templates.workers.dev](https://ras.templates.workers.dev)
